...
do
    ...
    t1_file=../res/tree_likelihood_comparison/h01/${marker_id}_h01_t1.info.txt
    t2_file=../res/tree_likelihood_comparison/h01/${marker_id}_h01_t2.info.txt
    t3_file=../res/tree_likelihood_comparison/h01/${marker_id}_h01_t3.info.txt
